...
def run_optimized_experiment():
    ...
    print("=" * 80)
    print("RICCI-REWA SELF-HEALING EXPERIMENT (OPTIMIZED)")
    print("=" * 80)
    print("\nOptimizations:")
    ...
    plot_self_healing_dynamics(history_recovery, history_curvature, 
                               save_path="results/self_healing_dynamics_optimized.png")
    plot_phase_comparison(entropy_genesis, entropy_damaged, entropy_healed,
                         save_path="results/phase_comparison_optimized.png")
    
    # --- SUMMARY ---
    print("\n" + "=" * 80)
    print("EXPERIMENT SUMMARY (OPTIMIZED)")
    print("=" * 80)
