...
from universal_curvature_experiment.model_loaders import GensimLoader
...
def check_norms():
    ...
    # Get sample vectors
    keys = list(model.key_to_index.keys())[:20000] # First 20k (frequent)
    # Also get random sample
    import random
    random.shuffle(keys)
    ...
    output_path = 'universal-curvature-experiment/results/w2vec_norm_dist.png'
