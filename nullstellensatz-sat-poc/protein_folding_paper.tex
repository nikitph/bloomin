...
\usepackage{graphicx, booktabs, geometry, xcolor, multicol}
...
% Hyperref removed to avoid font issues with BasicTeX
...
Implementation available at: github.com/ouroboros-sieve/topological-snap

% Bibliography removed to avoid font issues with BasicTeX
% References: Levinthal (1969), Jumper et al. (2021)
