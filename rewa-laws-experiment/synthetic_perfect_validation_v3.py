"""
PERFECT VALIDATION V3: Moderate Regime & Fine-Grained Rho

This script proves the mathematical exactness of χ = m·Δ² in the moderate signal regime.

Changes from V2:
1. Fine-grained rho: [0.25, 0.3, 0.35, 0.4, 0.45, 0.5]
2. Reduced witnesses: L = 75 (avoid saturation)
3. Reduced trials: n_trials = 3 (faster iteration)
4. Kept K=4 and m range
"""
...
class REWALabEnhanced:
    ...
    def encode(self, m, K_hashes=2, seed=42):
        ...
        # Use int16 to avoid overflow with K=4
...
def run_perfect_validation_v3():
    """
    Main experiment V3: Moderate regime with fine-grained rho
    """
    print("="*80)
    print(" PERFECT VALIDATION V3: Moderate Regime & Fine-Grained Rho")
    print("="*80)
    
    # --- UPDATED PARAMETERS ---
    rho_values = [0.25, 0.3, 0.35, 0.4, 0.45, 0.5]  # 6 points, moderate regime
    m_values = np.geomspace(16, 8192, num=12, dtype=int)
    n_trials = 3  # Reduced trials
    K_hashes = 4   # Keep at 4
    L = 75         # Reduced witnesses
    ...
    plt.suptitle('Semantic Thermodynamics V3: Moderate Regime & Fine-Grained Rho', 
                fontsize=16, fontweight='bold', y=0.995)
    
    plt.tight_layout()
    plt.savefig('synthetic_perfect_validation_v3.png', 
                dpi=300, bbox_inches='tight')
    print("\n✓ Saved: synthetic_perfect_validation_v3.png")
    ...
    with open('synthetic_results_v3.json', 'w') as f:
        json.dump(results_json, f, indent=2)
    
    print("✓ Saved: synthetic_results_v3.json")
    ...
    print("\n" + "="*80)
    print(" SUMMARY V3: Moderate Regime Validation")
    print("="*80)
